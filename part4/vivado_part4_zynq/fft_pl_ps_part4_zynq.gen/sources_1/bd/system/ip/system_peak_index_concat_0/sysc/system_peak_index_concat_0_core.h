...
#ifndef _system_peak_index_concat_0_core_h_
#define _system_peak_index_concat_0_core_h_
...
class system_peak_index_concat_0_core : public sc_module 
{
    public: 
       system_peak_index_concat_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(system_peak_index_concat_0_core);
    ...
    virtual ~system_peak_index_concat_0_core() = default;
