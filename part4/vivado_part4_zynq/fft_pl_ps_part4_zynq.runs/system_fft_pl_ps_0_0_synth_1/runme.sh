...
HD_PWD='X:/part4/vivado_part4_zynq/fft_pl_ps_part4_zynq.runs/system_fft_pl_ps_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_fft_pl_ps_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_fft_pl_ps_0_0.tcl
