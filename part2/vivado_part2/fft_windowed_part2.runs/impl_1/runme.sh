...
HD_PWD='C:/Users/USER/Documents/baryonic_space/baryonic_space-main/part2/vivado_part2/fft_windowed_part2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_windowed_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft_windowed_top.tcl -notrace
