...
HD_PWD='C:/Users/USER/Documents/baryonic_space/baryonic_space-main/part2/vivado_part2/fft_windowed_part2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_windowed_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_windowed_top.tcl
