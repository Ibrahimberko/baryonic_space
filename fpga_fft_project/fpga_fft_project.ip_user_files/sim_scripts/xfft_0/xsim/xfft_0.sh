...
#
# Script generated by Vivado on Fri May 01 15:43:30 +0300 2026
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xfft_0 xil_defaultlib.xfft_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim xfft_0 -key {Behavioral:sim_1:Functional:xfft_0} -tclbatch cmd.tcl -log simulate.log +MEM_DIR=C:/Users/USER/Documents/baryonic_space/baryonic_space-main/mem
}
