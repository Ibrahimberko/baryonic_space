...
class GettingComplex_Quad(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Quad Detail", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Quad Detail")
        ...
        self.settings = Qt.QSettings("GNU Radio", "GettingComplex_Quad")
        ...
        self._freq_range = Range(-300, 300, 100e-3, 300, 200)
        ...
        self._Q_range = Range(-1, 1, 10e-3, 0, 200)
        self._Q_win = RangeWidget(self._Q_range, self.set_Q, "'Q'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._Q_win, 0, 1, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._I_range = Range(-1, 1, 10e-3, 1, 200)
        self._I_win = RangeWidget(self._I_range, self.set_I, "'I'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._I_win, 0, 0, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_CONST_WAVE, 1000, Q, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_CONST_WAVE, 1000, I, 0, 0)
        ...
        self.connect((self.blocks_float_to_complex_0_0, 0), (self.qtgui_const_sink_x_0_0, 0))
        ...
        self.connect((self.blocks_throttle_0, 0), (self.blocks_multiply_xx_0_0_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(2, self.samp_rate, 500, 50, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(2, self.samp_rate, 500, 50, window.WIN_HAMMING, 6.76))
    ...
    def set_Q(self, Q):
        self.Q = Q
        self.analog_sig_source_x_1_0.set_amplitude(self.Q)
    ...
    def set_I(self, I):
        self.I = I
        self.analog_sig_source_x_1.set_amplitude(self.I)




def main(top_block_cls=GettingComplex_Quad, options=None):
