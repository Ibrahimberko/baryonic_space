...
class audio_demo(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Audio demo", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Audio demo")
        ...
        self.settings = Qt.QSettings("GNU Radio", "audio_demo")
...
def main(top_block_cls=audio_demo, options=None):
