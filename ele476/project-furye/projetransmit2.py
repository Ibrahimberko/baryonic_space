...
class projetransmit2(gr.top_block, Qt.QWidget):
    ...
    def set_bd(self, bd):
        self.bd = bd
        self.set_amplitude((self.b1+self.b2+self.b3+self.ba+self.b4+self.b5+self.b6+self.bb+self.b7+self.b8+self.b9+self.bc+self.b10+self.b0+self.b12+self.bd)*0.5)
        self.set_freq1((self.b1+self.b2+self.b3+self.ba)*697+(self.b4+self.b5+self.b6+self.bb)*770+(self.b7+self.b8+self.b9+self.bc)*852+(self.bd+self.b10+self.b0+self.b12)*941)
        self.set_freq2((self.b1+self.b4+self.b7+self.b10)*1209+(self.b2+self.b5+self.b8+self.b0)*1336+(self.b3+self.b6+self.b9+self.b12)*1477+(self.ba+self.bb+self.bc+self.bd)*1633)
