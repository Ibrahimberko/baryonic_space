...
HD_PWD='C:/Users/USER/Documents/baryonic_space/baryonic_space-main/part3/vivado_part3/fft_freqwin_part3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_freqwin_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_freqwin_top.tcl
