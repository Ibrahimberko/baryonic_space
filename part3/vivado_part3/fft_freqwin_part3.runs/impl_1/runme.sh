...
HD_PWD='C:/Users/USER/Documents/baryonic_space/baryonic_space-main/part3/vivado_part3/fft_freqwin_part3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_freqwin_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft_freqwin_top.tcl -notrace
