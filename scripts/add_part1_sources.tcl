...
add_files -fileset sim_1 [list \
    [file join $repo_root "tb" "part1" "tb_fft_naive.sv"] \
]
...
catch {set_property xsim.elaborate.xelab.more_options "" [get_filesets sim_1]}
catch {set_property xsim.simulate.xsim.more_options "-testplusarg MEM_DIR=$mem_dir" [get_filesets sim_1]}
