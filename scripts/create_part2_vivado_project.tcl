...
set source_tb [file join $repo_root "tb" "part2" "tb_fft_windowed.sv"]
...
set project_dir [file join $repo_root "part2" "vivado_part2"]
set project_name "fft_windowed_part2"
...
add_files -norecurse -fileset sources_1 [list \
    ...
    [file join $repo_root "rtl" "part2" "hamming_window.v"] \
    [file join $repo_root "rtl" "part2" "fft_windowed_top.v"] \
    [file join $repo_root "mem" "hamming_256.mem"] \
]
...
set_property top fft_windowed_top [get_filesets sources_1]
set_property top tb_fft_windowed [get_filesets sim_1]
...
puts "Part 2 Vivado project created at: $project_dir/$project_name.xpr"
puts "MEM_DIR=$mem_dir"
puts "COEF_FILE=[file join $repo_root mem hamming_256.mem]"
