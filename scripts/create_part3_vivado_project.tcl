...
set source_tb [file join $repo_root "tb" "part3" "tb_fft_freqwin.sv"]
...
set project_dir [file join $repo_root "part3" "vivado_part3"]
set project_name "fft_freqwin_part3"
...
add_files -norecurse -fileset sources_1 [list \
    ...
    [file join $repo_root "rtl" "part3" "three_term.v"] \
    [file join $repo_root "rtl" "part3" "fft_freqwin_top.v"] \
]
...
set_property top fft_freqwin_top [get_filesets sources_1]
set_property top tb_fft_freqwin [get_filesets sim_1]
...
puts "Part 3 Vivado project created at: $project_dir/$project_name.xpr"
